...
{
    public override AbilityData Setup() => new PlayerMovementData();

    internal override float FallSpeed(PlayerAbilityController abCont, AbilityData data, bool isJumping)
    {
    ...
    internal override void Move(PlayerAbilityController abCont, AbilityData data, Vector3 moveInput, bool dashInput)
    {
        PlayerMovementData pmd = (PlayerMovementData)data;
